...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA KORAN TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
      <div class="col s6 m6 l3" >
        <ul id="dropdown1" class="dropdown-content">
          <li><a href="/fakultas_koran_FIB?keyword=2021" class="-text">FIB{{-- <span class="badge"></span> --}}</a>
          </li>
          <li><a href="/fakultas_koran_FKIP?keyword=2021" class="-text">FKIP{{-- <span class="new badge "></span> --}}</a>
          </li>
          <li><a href="/fakultas_koran_FH?keyword=2021" class="-text">FH</a>
          </li>
          <li><a href="/fakultas_koran_FEB?keyword=2021" class="-text">FEB</a>
          </li>
          <li><a href="/fakultas_koran_FISIP?keyword=2021" class="-text">FISIP</a>
          </li>
          <li><a href="/fakultas_koran_FP?keyword=2021" class="-text">FP</a>
          </li>
          <li><a href="/fakultas_koran_FK?keyword=2021" class="-text">FK</a>
          </li>
          <li><a href="/fakultas_koran_FT?keyword=2021" class="-text">FT</a>
          </li>
          <li><a href="/fakultas_koran_FMIPA?keyword=2021" class="-text">FMIPA</a>
          </li>
          <li><a href="/fakultas_koran_FSRD?keyword=2021" class="-text">FSRD</a>
          </li>
          <li><a href="/fakultas_koran_FKOR?keyword=2021" class="-text">FKOR</a>
          </li>
          <li><a href="/fakultas_koran_SV?keyword=2021" class="-text">SV</a>
          </li>
        </ul>
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Koran Per Tahun'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
                    ...
                    <ul class="slides">
                      <li>
                        <div id="chartKoran6">
                          ...
                          chart: {type: 'line'},
                          title: {text: 'Kategori Koran per Fakultas'},
