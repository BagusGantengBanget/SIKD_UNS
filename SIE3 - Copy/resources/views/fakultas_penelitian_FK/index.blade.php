...
@section('title', 'Data Penelitian FK')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA PENELITIAN FAKULTAS KEDOKTERAN TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l6">
        <div class="card">
          <div id="chartpenelitian3">
            ...
            title: { 
                text: 'Status Data Penelitian Fakultas Kedokteran',
            },
            xAxis: {
