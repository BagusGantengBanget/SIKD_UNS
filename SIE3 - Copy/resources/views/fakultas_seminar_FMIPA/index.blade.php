...
@section('title', 'Kinerja Seminar FMIPA')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA SEMINAR FAKULTAS MATEMATIKA & ILMU PENGETAHUAN ALAM TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Seminar Per Tahun di Fakultas Matematika & Ilmu Pengetahuan Alam'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
