...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA JURNAL TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
      <div class="col s6 m6 l3" {{-- style="margin-top: 7px" --}}>
        <ul id="dropdown1" class="dropdown-content">
          <li><a href="/fakultas_jurnal_FIB?keyword=2021" class="-text">FIB{{-- <span class="badge"></span> --}}</a>
          </li>
          <li><a href="/fakultas_jurnal_FKIP?keyword=2021" class="-text">FKIP{{-- <span class="new badge "></span> --}}</a>
          </li>
          <li><a href="/fakultas_jurnal_FH?keyword=2021" class="-text">FH</a>
          </li>
          <li><a href="/fakultas_jurnal_FEB?keyword=2021" class="-text">FEB</a>
          </li>
          <li><a href="/fakultas_jurnal_FISIP?keyword=2021" class="-text">FISIP</a>
          </li>
          <li><a href="/fakultas_jurnal_FP?keyword=2021" class="-text">FP</a>
          </li>
          <li><a href="/fakultas_jurnal_FK?keyword=2021" class="-text">FK</a>
          </li>
          <li><a href="/fakultas_jurnal_FT?keyword=2021" class="-text">FT</a>
          </li>
          <li><a href="/fakultas_jurnal_FMIPA?keyword=2021" class="-text">FMIPA</a>
          </li>
          <li><a href="/fakultas_jurnal_FSRD?keyword=2021" class="-text">FSRD</a>
          </li>
          <li><a href="/fakultas_jurnal_FKOR?keyword=2021" class="-text">FKOR</a>
          </li>
          <li><a href="/fakultas_jurnal_SV?keyword=2021" class="-text">SV</a>
          </li>
        </ul>
    ...
    <div class="col s12 m4 l8">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Jurnal Per Tahun'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
                    ...
                    <ul class="slides">
                      <li>
                        <div id="chartJurnal7">
                          ...
                          chart: {type: 'line'},
                          title: {text: 'Kategori Jurnal per Fakultas'},
