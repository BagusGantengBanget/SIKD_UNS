...
@section('title', 'Kinerja Pembicara FMIPA')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA PEMBICARA FAKULTAS MATEMATIKA & ILMU PENGETAHUAN ALAM TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
      <div class="col s6 m6 l3" >
          ...
          <ul id="dropdown1" class="dropdown-content">
            <li class="{{ 'fakultas_pembicara_FIB' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FIB?keyword=2021" class="-text">FIB</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FKIP' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FKIP?keyword=2021" class="-text">FKIP</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FH' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FH?keyword=2021" class="-text">FH</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FEB' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FEB?keyword=2021" class="-text">FEB</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FISIP' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FISIP?keyword=2021" class="-text">FISIP</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FP' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FP?keyword=2021" class="-text">FP</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FK' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FK?keyword=2021" class="-text">FK</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FT' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FT?keyword=2021" class="-text">FT</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FMIPA' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FMIPA?keyword=2021" class="-text">FMIPA</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FSRD' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FSRD?keyword=2021" class="-text">FSRD</a>
            </li>
            <li class="{{ 'fakultas_pembicara_FKOR' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_FKOR?keyword=2021" class="-text">FKOR</a>
            </li>
            <li class="{{ 'fakultas_pembicara_SV' == request()->path() ? 'active' : '' }}">
              <a href="/fakultas_pembicara_SV?keyword=2021" class="-text">SV</a>
            </li>
          </ul>
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data pembicara Per Tahun di Fakultas Matematika & Ilmu Pengetahuan Alam'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
                    ...
                    <ul class="slides">
                      <li>
                        <div id="chartPembicara10">
                          ...
                          chart: {type: 'line'},
                          title: {text: 'Kategori Pembicara Program Studi'},
  ...
  <script>
    $(document).ready(function() {
      var table = $('datatable').DataTable({
        'processing' : true,
        'serverSide':true,
        'ajax': "{{ route('api.Kinerja_pembicara.index') }}",
        'columns': [
          {'data': 'judul_pembicara'},
          {'data': 'penerbit'},
          {'data': 'isbn'},
          {'data': 'tahun'},
          {'data': 'status_pembicara'},
          {'data': 'halaman'},
          {'data': 'tanggal_rev'},
          {'data': 'status_bayar'}
    ...
    {{-- <div class="container">
      ...
      <script>
        ...
        function drawChart() {
          ...
          var options = {
            chart: {
              title: 'Grafik Kinerja pembicara',
              subtitle: '',
            }
          };
