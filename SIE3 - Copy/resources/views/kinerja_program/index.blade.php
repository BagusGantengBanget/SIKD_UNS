...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA PROGRAM TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
      <div class="col s6 m6 l3" >
        <ul id="dropdown1" class="dropdown-content">
          <li><a href="/fakultas_program_FIB?keyword=2021" class="-text">FIB{{-- <span class="badge"></span> --}}</a>
          </li>
          <li><a href="/fakultas_program_FKIP?keyword=2021" class="-text">FKIP{{-- <span class="new badge "></span> --}}</a>
          </li>
          <li><a href="/fakultas_program_FH?keyword=2021" class="-text">FH</a>
          </li>
          <li><a href="/fakultas_program_FEB?keyword=2021" class="-text">FEB</a>
          </li>
          <li><a href="/fakultas_program_FISIP?keyword=2021" class="-text">FISIP</a>
          </li>
          <li><a href="/fakultas_program_FP?keyword=2021" class="-text">FP</a>
          </li>
          <li><a href="/fakultas_program_FK?keyword=2021" class="-text">FK</a>
          </li>
          <li><a href="/fakultas_program_FT?keyword=2021" class="-text">FT</a>
          </li>
          <li><a href="/fakultas_program_FMIPA?keyword=2021" class="-text">FMIPA</a>
          </li>
          <li><a href="/fakultas_program_FSRD?keyword=2021" class="-text">FSRD</a>
          </li>
          <li><a href="/fakultas_program_FKOR?keyword=2021" class="-text">FKOR</a>
          </li>
          <li><a href="/fakultas_program_SV?keyword=2021" class="-text">SV</a>
          </li>
        </ul>
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Program Per Tahun'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
                    ...
                    <ul class="slides">
                      <li>
                        ...
                        <div id="chartProgram4">
                          ...
                          chart: {type: 'line'},
                          title: {text: 'Kategori Program per Fakultas'},
