...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA SCOPUS TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
    <div class="row">
        <div class="col s6 m6 l3" >
          <ul id="dropdown1" class="dropdown-content">
            <li><a href="/fakultas_scopus_FIB?keyword=2021" class="-text">FIB{{-- <span class="badge"></span> --}}</a>
            </li>
            <li><a href="/fakultas_scopus_FKIP?keyword=2021" class="-text">FKIP{{-- <span class="new badge "></span> --}}</a>
            </li>
            <li><a href="/fakultas_scopus_FH?keyword=2021" class="-text">FH</a>
            </li>
            <li><a href="/fakultas_scopus_FEB?keyword=2021" class="-text">FEB</a>
            </li>
            <li><a href="/fakultas_scopus_FISIP?keyword=2021" class="-text">FISIP</a>
            </li>
            <li><a href="/fakultas_scopus_FP?keyword=2021" class="-text">FP</a>
            </li>
            <li><a href="/fakultas_scopus_FK?keyword=2021" class="-text">FK</a>
            </li>
            <li><a href="/fakultas_scopus_FT?keyword=2021" class="-text">FT</a>
            </li>
            <li><a href="/fakultas_scopus_FMIPA?keyword=2021" class="-text">FMIPA</a>
            </li>
            <li><a href="/fakultas_scopus_FSRD?keyword=2021" class="-text">FSRD</a>
            </li>
            <li><a href="/fakultas_scopus_FKOR?keyword=2021" class="-text">FKOR</a>
            </li>
            <li><a href="/fakultas_scopus_SV?keyword=2021" class="-text">SV</a>
            </li>
          </ul>
      ...
      <div class="col s12 m4 l8">
        <div class="card">
          ...
          Highcharts.chart('chartline', {
            ...
            title: {
                text: 'Jumlah Data Scopus Per Tahun'
            },
            legend: {
                layout: 'vertical',
                align: 'left',
                      ...
                      <ul class="slides">
                        <li>
                          <div id="chartJurnal15">
                            ...
                            chart: {type: 'line'},
                            title: {text: 'Kategori Scopus per Fakultas'},
...
{{-- <div class="container">
  <div class="row">
    <div class="col s12 m4 l3">
      <input type="search" name="keyword" value="{{ $keyword }}" placeholder="Cari Nama / Judul" >
      <button type="submit" class="btn waves-effect waves-light blue" >cari</button>
    </div>
  </div>    
</div> --}}
<div class="container">
