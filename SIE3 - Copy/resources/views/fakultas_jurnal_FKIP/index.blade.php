...
@section('title', 'Kinerja Jurnal FKIP')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA JURNAL FAKULTAS KEGURUAN & ILMU PENDIDIKAN TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l8">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Jurnal Per Tahun di Fakultas Keguruan dan Ilmu Pendidikan'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
