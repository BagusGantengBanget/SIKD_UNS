...
@section('title', 'Kinerja Karyacipta SV')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA KARYACIPTA SEKOLAH VOKASI TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Karyacipta Per Tahun di Sekolah Vokasi'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
