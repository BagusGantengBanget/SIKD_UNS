...
@section('title', 'Kinerja Koran FSRD')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA KORAN FAKULTAS SENIRUPA & DESAIN TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Koran Per Tahun di Fakultas Seni Rupa & Desain'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
