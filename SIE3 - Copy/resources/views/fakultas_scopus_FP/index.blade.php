...
@section('title', 'Kinerja Scopus FP')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA SCOPUS FAKULTAS PERTANIAN TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l8">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Scopus Per Tahun di Fakultas Pertanian'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
