...
@section('title', 'Kinerja Buku FISIP')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA BUKU FAKULTAS ILMU SOSIAL & ILMU POLITIK TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Buku Per Tahun di Fakultas Ilmu Sosial dan Ilmu Politik'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
