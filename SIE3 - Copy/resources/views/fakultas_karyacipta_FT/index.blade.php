...
@section('title', 'Kinerja Karyacipta FT')
@section('content')
<head>
...
<div class="container">
  <h1 style="color: grey"><b>DATA KINERJA KARYACIPTA FAKULTAS TEKNIK TAHUN {{ $tahunpen }}</b></h1>
</div>
<div class="container">
  <div class="row">
    ...
    <div class="col s12 m4 l12">
      <div class="card">
        ...
        Highcharts.chart('chartline', {
          ...
          title: {
              text: 'Jumlah Data Karyacipta Per Tahun di Fakultas Teknik'
          },
          legend: {
              layout: 'vertical',
              align: 'left',
