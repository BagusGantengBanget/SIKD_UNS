...
class Data_penelitianController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('data_penelitian.index'  ,compact( 'data', 'keyword', 'categoriesval', 'dataval', 'categoriesfak', 'datafak','tahunpen',
