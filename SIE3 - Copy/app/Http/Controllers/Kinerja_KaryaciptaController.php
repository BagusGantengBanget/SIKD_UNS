...
class Kinerja_KaryaciptaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kinerja_karyacipta.index', compact( 'data', 'keyword', 'categoriesval','dataval', 'categoriescat', 'datacat', 'tahunpen',
	...
	{
		return Excel::download(new KaryaciptaExport, 'Kinerja_Karya_Cipta.xlsx');
	}
