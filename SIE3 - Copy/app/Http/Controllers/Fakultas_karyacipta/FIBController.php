...
class FIBController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where('REF_UNIT_FAKULTAS.FAKULTAS', '=', 'FIB')
       ...
       ->get()->count();
        ...
        return view('fakultas_karyacipta_FIB.index'  ,compact( ['data'], 'keyword','categoriesval','dataval', 'categoriescat', 'datacat', 'tahunpen',
