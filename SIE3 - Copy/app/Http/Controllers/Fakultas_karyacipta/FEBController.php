...
class FEBController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->where('REF_UNIT_FAKULTAS.FAKULTAS', '=', 'FEB')
       ...
       ->get()->count();
        ...
        return view('fakultas_karyacipta_FEB.index'  ,compact( ['data'], 'keyword','categoriesval','dataval', 'categoriescat', 'datacat', 'tahunpen',
