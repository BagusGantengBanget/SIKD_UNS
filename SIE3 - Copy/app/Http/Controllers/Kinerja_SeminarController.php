...
class Kinerja_SeminarController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kinerja_seminar.index', compact('data', 'keyword', 'categoriesval', 'dataval', 'categoriescat', 'datacat', 'tahunpen',
