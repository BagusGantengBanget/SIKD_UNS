...
class Kinerja_KaryaseniController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kinerja_karyaseni.index', compact( 'data', 'keyword', 'categoriesval','dataval', 'categoriescat', 'datacat', 'tahunpen',
	...
	{
		return Excel::download(new KaryaseniExport, 'Kinerja_Karya_Seni.xlsx');
	}
}
