...
class Kinerja_BukuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        ->orWhere('kinerja_buku.tahun','like','%'.$keyword.'%')
        ...
        $validasifak = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        //Grafik Kategori
        $catbuku = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
       ...
       ->get()->count();
        ...
        return view('kinerja_buku.index'  ,compact( ['data'], 'keyword', 'categoriesval', 'dataval', 'categoriescat', 'datacat', 'tahunpen',
...
/* $cat1 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->get()
        ->count();
        $cat2 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->get()
        ->count();
        $cat3 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->get()
        ->count();
        $cat4 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->get()
        ->count();
        $cat5 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->get()
        ->count();
        $cat6 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->get()
        ->count();
        $cat7 = DB::table('kinerja_buku_author')
        ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
        ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
        ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
        ...
        ->count(); */
         ...
         /* $ditolak = DB::table('kinerja_buku_author')
       ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
       ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('remun_point_terindex', 'kinerja_buku.id_terindek', '=', 'remun_point_terindex.id_terindek' ) 
       ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
       ->join('REF_UNIT_FAKULTAS', 'dosen.id_unit', '=', 'REF_UNIT_FAKULTAS.ID_FAKULTAS')
       ->where('status_buku', '=', 'Ditolak')
       ->groupBy('kinerja_buku.tahun')
       ->select('kinerja_buku.tahun',  \DB::raw('count(*) as totalditolak'))
       ->get();

       $categoriesditolak = [];
        $dataditolak=[];
        foreach($ditolak as $dt){
            $categoriesditolak[] = $dt->tahun;
            $dataditolak[] = $dt->totalditolak;
        }

        $menunggu = DB::table('kinerja_buku_author')
       ->join('kinerja_buku', 'kinerja_buku.id_buku', '=', 'kinerja_buku_author.id')
       ->join('dosen', 'dosen.nidn', '=', 'kinerja_buku_author.nidn')
        ->join('remun_point_terindex', 'kinerja_buku.id_terindek', '=', 'remun_point_terindex.id_terindek' ) 
       ->join('REF_UNIT', 'dosen.id_sub_unit', '=', 'REF_UNIT.ID' ) 
       ...
       ->where('status_buku', '=', 'Menunggu')
       ->groupBy('kinerja_buku.tahun')
       ->select('kinerja_buku.tahun',  \DB::raw('count(*) as totalmenunggu'))
       ->get();

       $categoriesmenunggu = [];
        $datamenunggu=[];
        foreach($menunggu as $dt){
            $categoriesmenunggu[] = $dt->tahun;
            $datamenunggu[] = $dt->totalmenunggu;
        }
       dd($datamenunggu); */