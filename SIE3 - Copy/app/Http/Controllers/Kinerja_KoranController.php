...
class Kinerja_KoranController extends Controller
{
    public function index(Request $request)
    {
       ...
       ->get()->count();
        ...
        return view('kinerja_koran.index', compact( 'data', 'keyword', 'categoriesval','dataval', 'categoriescat', 'datacat', 'tahunpen',
