...
class FKORController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('fakultas_penelitian_FKOR.index'  ,compact( 'data', 'keyword','categoriesval', 'dataval', 'categoriesfak', 'datafak','tahunpen',
        'categoriesilmu', 'datailmu','categorieskajian', 'datakajian',
