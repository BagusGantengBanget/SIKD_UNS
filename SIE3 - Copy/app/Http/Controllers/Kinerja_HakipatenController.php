...
class Kinerja_HakipatenController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kinerja_hakipaten.index', compact( 'data', 'keyword', 'categoriesval', 'dataval', 'categoriescat', 'datacat', 'tahunpen',
