...
class Kinerja_ProgramController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kinerja_program.index', compact( 'data', 'keyword', 'categoriesval','dataval', 'categoriescat', 'datacat', 'tahunpen',
